...
<!--
    ...
    TODO: Remove dependence on this as I guess this would make this module
    subject to LGPL instead of Apache licensed
                ...
                <fo:table-body>
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            <!--<fo:block>-->
                            <!--<fo:external-graphic src="file:images/hibernate_logo_a.gif"/>-->
                            <!--</fo:block>-->
