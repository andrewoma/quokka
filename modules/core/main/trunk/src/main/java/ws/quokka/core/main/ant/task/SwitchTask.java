 ...
 *   <code>
 *     &lt;taskdef name="switch" classname="net.sf.antcontrib.logic.SwitchTask" /&gt;
 *   </code>
 * <p/>
 *   Task calling syntax:
 *    <code>
...
public class SwitchTask extends Task {
     ...
     */
    public SwitchTask.Case createCase() throws BuildException {
        SwitchTask.Case res = new SwitchTask.Case();
