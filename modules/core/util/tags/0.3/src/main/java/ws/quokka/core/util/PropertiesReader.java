...
public class PropertiesReader extends LineNumberReader {
    ...
    private static String unescapeJava(final String str) {
        return (String)new ExceptionHandler() {
     ...
     */
    private static void unescapeJava(Writer out, String str)
            throws IOException {
        int sz = str.length();
        ...
        for (int i = 0; i < sz; i++) {
            ...
            if (inUnicode) {
                ...
                if (unicode.length() == UNICODE_LEN) {
                    ...
                    try {
                        ...
                        throw new BuildException("Unable to parse unicode value: " + unicode, nfe);
                    }
                }
            ...
            if (hadSlash) {
                ...
                // Fails test against JDK, so removed
                //                    case'b':
                //                        out.write('\b');
                //                        break;
                case 'u': {
